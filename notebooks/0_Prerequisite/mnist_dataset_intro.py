...
# This shows us that each image has an array of 784 items associated with it, defining the image, whilst each label item has a 10 item array associated with it, where the correct digit in the image is indicated by a 1, with the remaining being 0.
